...
wf::cursor_t::cursor_t(wf::seat_t *seat) {
  ...
  config_reloaded = [=](auto) { init_xcursor(); };
...
bool wf::cursor_t::can_client_set_cursor() {
  /* WIPE: touchscreen_mode_active check removed */
...
void wf::cursor_t::init_cursor_shape_manager() {
  cursor_shape_manager =
      wlr_cursor_shape_manager_v1_create(seat->seat->display, 1);
...
void wf::cursor_t::set_cursor(wlr_seat_pointer_request_set_cursor_event *ev,
